...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    body { font-family: 'Press Start 2P', monospace; background: var(--bg-dark); color: var(--text-main); min-height: 100vh; overflow-x: hidden; }
    ...
    .live-badge { display: inline-flex; align-items: center; gap: 8px; background: var(--neon-red); color: white; padding: 5px 15px; font-size: 0.5rem; animation: pulse 1s infinite; }
    ...
    .version-badge { font-size: 0.4rem; background: var(--neon-purple); color: white; padding: 3px 8px; border-radius: 3px; margin-left: 10px; }
    .viewer-count { font-size: 0.5rem; color: var(--neon-pink); }
    ...
    .panel-title { font-size: 0.6rem; margin-bottom: 12px; display: flex; align-items: center; gap: 8px; color: var(--neon-yellow); text-shadow: 0 0 10px var(--neon-yellow); border-bottom: 2px dashed var(--border-color); padding-bottom: 8px; }
    .controls { display: flex; gap: 8px; margin-bottom: 12px; justify-content: center; flex-wrap: wrap; }
    .btn { font-family: 'Press Start 2P', monospace; font-size: 0.45rem; padding: 10px 15px; border: none; cursor: pointer; transition: all 0.2s; }
    ...
    .status-bar { display: flex; justify-content: center; gap: 20px; margin-bottom: 12px; flex-wrap: wrap; font-size: 0.45rem; }
    ...
    .agent-type { font-size: 0.35rem; color: var(--text-dim); margin-top: 3px; }
    .agent-defect { font-size: 0.35rem; color: var(--neon-orange); margin-bottom: 5px; }
    ...
    .unhealth-title { font-size: 0.35rem; color: var(--neon-pink); margin-bottom: 5px; display: flex; align-items: center; gap: 5px; }
    ...
    .unhealth-item .emoji { font-size: 0.5rem; }
    ...
    .unhealth-value { font-size: 0.3rem; width: 20px; text-align: right; }
    ...
    .thought-bubble { background: rgba(255,255,255,0.1); border: 1px solid var(--neon-purple); padding: 6px 8px; font-size: 0.35rem; color: var(--text-main); position: relative; margin-top: 5px; line-height: 1.5; }
    .thought-bubble::before { content: '💭'; position: absolute; top: -8px; left: 5px; font-size: 0.5rem; }
    ...
    .effect-tag { font-size: 0.3rem; padding: 2px 5px; border-radius: 3px; }
    ...
    .pixel-map { font-family: 'Press Start 2P', monospace; font-size: 10px; line-height: 1.3; background: #050508; padding: 12px; border: 3px solid var(--border-color); overflow-x: auto; white-space: pre; }
    .floor-section { margin-bottom: 15px; }
    .floor-header { display: flex; justify-content: space-between; margin-bottom: 8px; font-size: 0.5rem; }
    ...
    .donation-btn { display: block; width: 100%; padding: 10px; margin-bottom: 8px; font-family: 'Press Start 2P', monospace; font-size: 0.4rem; background: var(--bg-card); border: 2px solid var(--neon-gold); color: var(--neon-gold); cursor: pointer; transition: all 0.2s; }
    .donation-btn:hover { background: var(--neon-gold); color: var(--bg-dark); box-shadow: 0 0 20px var(--neon-gold); }
    .recent-donations { margin-top: 15px; font-size: 0.35rem; }
    ...
    .vote-btn { padding: 10px; font-family: 'Press Start 2P', monospace; font-size: 0.4rem; background: var(--bg-card); border: 2px solid var(--neon-cyan); color: var(--neon-cyan); cursor: pointer; transition: all 0.2s; }
    ...
    .leaderboard-section h4 { font-size: 0.4rem; color: var(--neon-pink); margin-bottom: 8px; text-align: center; }
    .leaderboard-item { font-size: 0.35rem; padding: 4px 6px; background: var(--bg-card); margin-bottom: 4px; display: flex; justify-content: space-between; border-left: 3px solid var(--neon-purple); }
    ...
    .event-item { font-size: 0.35rem; padding: 8px; background: var(--bg-card); border-left: 4px solid var(--neon-purple); line-height: 1.5; }
    ...
    .event-time { color: var(--text-dim); font-size: 0.3rem; }
    ...
    .boss-name { font-size: 0.5rem; color: var(--neon-gold); text-align: center; margin-bottom: 8px; }
    ...
    <div class="main-grid">
      ...
      <div class="panel donation-panel">
        ...
        <div class="recent-donations">
          <h4 style="font-size: 0.4rem; color: var(--neon-gold); margin-bottom: 8px;">最近打赏</h4>
...
function startAutoTick() {
  ...
  autoTickInterval = setInterval(function() { singleTick(); fetchEvents(); }, tickSpeed);
}
...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    html, body { width: 100%; height: 100%; overflow: hidden; font-family: 'Press Start 2P', monospace; background: var(--bg-dark); color: var(--text-main); }
    body::before { content: ''; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(0, 0, 0, 0.1) 2px, rgba(0, 0, 0, 0.1) 4px); pointer-events: none; z-index: 9999; }
    ...
    .live-text { font-size: 0.6rem; color: var(--neon-cyan); text-shadow: 0 0 10px var(--neon-cyan); }
    .title { font-size: 0.8rem; color: var(--neon-yellow); text-shadow: 0 0 15px var(--neon-yellow); }
    .version-tag { font-size: 0.35rem; background: var(--neon-purple); padding: 3px 8px; margin-left: 10px; border-radius: 3px; }
    .header-stats { display: flex; gap: 25px; font-size: 0.45rem; }
    ...
    .speech-bubble { position: absolute; background: rgba(0, 0, 0, 0.85); border: 2px solid var(--neon-purple); border-radius: 10px; padding: 8px 12px; font-size: 0.4rem; color: var(--text-main); max-width: 150px; pointer-events: none; z-index: 100; animation: bubble-rise 3s forwards; box-shadow: 0 0 15px var(--neon-purple); }
    ...
    .damage-number { position: absolute; font-size: 0.6rem; font-weight: bold; color: var(--neon-red); text-shadow: 0 0 10px var(--neon-red), 2px 2px 0 #000; pointer-events: none; animation: damage-float 1s forwards; z-index: 200; }
    ...
    .popup-subtitle { font-size: 0.5rem; color: var(--text-main); }
    .danmaku-container { position: absolute; top: 0; left: 0; width: 100%; height: 100%; pointer-events: none; overflow: hidden; }
    .danmaku { position: absolute; white-space: nowrap; font-size: 0.5rem; color: white; text-shadow: 1px 1px 2px black; animation: danmaku-move 8s linear forwards; }
    ...
    .panel-title { font-size: 0.45rem; color: var(--neon-yellow); margin-bottom: 10px; text-shadow: 0 0 10px var(--neon-yellow); }
    ...
    .agent-name { font-size: 0.4rem; color: var(--neon-yellow); margin-bottom: 4px; }
    ...
    .agent-effect { font-size: 0.3rem; padding: 2px 4px; border-radius: 3px; margin-right: 3px; }
    ...
    .boss-hp-fill { height: 100%; background: linear-gradient(90deg, var(--neon-red), var(--neon-gold)); transition: width 0.5s; }
    .events-scroll { max-height: 150px; overflow-y: auto; font-size: 0.35rem; line-height: 1.6; }
    ...
    .btn { font-family: 'Press Start 2P', monospace; font-size: 0.4rem; padding: 10px 20px; border: 2px solid; cursor: pointer; transition: all 0.2s; background: var(--bg-card); }
    ...
    .donate-btn { font-family: 'Press Start 2P', monospace; font-size: 0.35rem; padding: 8px 12px; border: 2px solid var(--neon-gold); color: var(--neon-gold); background: var(--bg-card); cursor: pointer; transition: all 0.2s; }
    ...
    .vote-btn { font-family: 'Press Start 2P', monospace; font-size: 0.35rem; padding: 8px 12px; border: 2px solid var(--neon-pink); color: var(--neon-pink); background: var(--bg-card); cursor: pointer; transition: all 0.2s; }
    .vote-btn:hover, .vote-btn.selected { background: var(--neon-pink); color: var(--bg-dark); }
    .input-group { display: flex; gap: 8px; }
    .danmaku-input { font-family: 'Press Start 2P', monospace; font-size: 0.4rem; padding: 8px 12px; border: 2px solid var(--neon-purple); background: var(--bg-card); color: var(--text-main); width: 180px; }
    .danmaku-input::placeholder { color: var(--text-dim); }
    @media (max-width: 900px) { .game-container { grid-template-columns: 1fr; grid-template-rows: 50px 1fr 160px 60px; } .side-panel { display: none; } .header-stats { font-size: 0.35rem; gap: 15px; } .title { font-size: 0.5rem; } }
  </style>
</head>
<body>
